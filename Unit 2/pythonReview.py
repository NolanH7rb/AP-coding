...
Homework = True
Classwork = True
if Homework and Classwork:
        
        print('These Assignments have been submitted!')
...
mytxt = ReverseITnow("Mr Ian is the Goat of Coding")
...
def GuessThat():
    ...
    while guess != x:
        guess= input('what is the secret number')
        if  guess < x:
            print('Your close! Go Higher')
            guess= input('what is the secret number')

        elif    guess > x:
            print('Your close! Go Lower')
